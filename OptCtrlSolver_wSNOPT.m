...
P.nonlcon = @(z)myConstraints(z,packSize,defects,dynamics,contactDyn,OCP.compCst);
...
function [c, ceq] = myConstraints (z,packSize,defects,dynamics,contactDyn,compCst)
