...
% Define folder names
solnFolderName = 'slanted_grnd/solutions';

% Add paths
addpath(genpath('../../..'));
addpath(solnFolderName );
addpath('slanted_grnd/autogenFncs');
addpath('slanted_grnd/wrapperFncs');
addpath('slanted_grnd/helperFncs');
%% ----------------------------------------------------------
%   MODEL PROPERTIES
...
overWrite = 1;
Notes = 'Added slack to constraints';
